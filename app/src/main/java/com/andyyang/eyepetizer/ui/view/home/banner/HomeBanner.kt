...
import com.andyyang.eyepetizer.ui.view.common.JumpShowTextView
...
class HomeBanner : FrameLayout {
    ...
    private fun initView() {
        ...
        viewPager.layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, C.getRealHeight(810)!!)
        ...
        homePageHeaderIcon.setImageResource(R.drawable.home_page_header_icon)
        homePageHeaderIcon.scaleType = ImageView.ScaleType.CENTER_INSIDE
        homePageHeaderIcon.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, C.getRealHeight(110)!!)

        tvTitle.textSize = 52f
        tvTitle.color = Color.WHITE
        tvTitle.isBold = true
        tvTitle.marginBottom = C.dip2px(5f)?.toFloat()!!
        ...
        val layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, C.getRealHeight(20)!!)
        layoutParams.topMargin = C.getRealHeight(30)!!
        layoutParams.bottomMargin = C.getRealHeight(28)!!
    ...
    fun setIndicators(bannerDatas: ArrayList<Item>) {
        ...
        bannerDatas.forEach { _ ->
            ...
            val layoutParams = LinearLayout.LayoutParams(C.getRealHeight(20)!!, C.getRealHeight(20)!!)
            layoutParams.leftMargin = C.getRealWidth(10)!!
            layoutParams.rightMargin = C.getRealWidth(10)!!
