    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && C.INSTANCE.getContext().getExternalCacheDir() != null)
                defaultDir = C.INSTANCE.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = C.INSTANCE.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
